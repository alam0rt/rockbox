...
#define DOOMBUTTON_RIGHT   BUTTON_PLAY
#define DOOMBUTTON_SHOOT   BUTTON_VOL
#define DOOMBUTTON_OPEN    (BUTTON_MENU|BUTTON_PLAY)
#define DOOMBUTTON_ESC     (BUTTON_PREV|BUTTON_NEXT)
#define DOOMBUTTON_ENTER   BUTTON_VOL
#define DOOMBUTTON_WEAPON  (BUTTON_PREV|BUTTON_VOL)
